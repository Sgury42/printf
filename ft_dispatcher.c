...
/*   Updated: 2019/05/24 17:51:27 by flbeaumo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_dispatcher(va_list ap, t_data_tab *data, t_buff *buff)
{
    ...
    i = 0;
    static char *fct_name[NB_FUNC] = {"c", "s", "d", "x", "o"};
    while (i < NB_FUNC)
    {
    ...
    static int (*fct_list[NB_FUNC])(va_list, t_data_tab *, t_buff *) = {pf_c, pf_s, pf_d, pf_x, pf_o};
    if (i >= 0 && i < NB_FUNC)
	{
