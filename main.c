...
static int  test_d()
{
    ...
    ft_putstr(FAIL"[TEST] ft_printf(GREEN\"[FT_PRINTF] - This is a test for %lld !!\", (long long)4444445555555)\n");
    ...
    ft_putstr(FAIL"[TEST] ft_printf(GREEN\"[FT_PRINTF] - This is a test for %015d !!\", 444444)\n");
    ft_printf(GREEN"[FT_PRINTF] - This is a test for %015d !!\n\n\n", 444444); 
    printf(GREEN"[TR_PRINTF] - This is a test for %015d !!\n\n\n", 444444); 

    ft_putstr(FAIL"[TEST] ft_printf(GREEN\"[FT_PRINTF] - This is a test for % 15d !!\", 424242)\n");
    ...
    ft_putstr(FAIL"[TEST] ft_printf(GREEN\"[FT_PRINTF] - This is a test for %+d !!\", 15151515)\n");
    ft_printf(GREEN"[FT_PRINTF] - This is a test for %+d !!\n\n\n", -1515151515); 
    printf(GREEN"[TR_PRINTF] - This is a test for %+d !!\n\n\n", -1515151515); 
